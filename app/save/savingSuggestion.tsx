  ...
  useEffect(() => {
    const fetchGoalSuggestion = async () => {
      try {
        ...
        const response = await fetch(`${base_url}/savesuggestion/all`, {
          method: "POST",
          headers: {
    ...
    <View style={styles.suggestionCard}>
      <View style={styles.topRow}>
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.durationText}>{item.category}</Text>
        </View>
      ...
      <View style={styles.separator} >
          <Text style={styles.durationText}>{item.difficulty}</Text>
      </View>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Saving Suggestions</Text>
      </View>
      ...
      {loading ? (
        ...
        <Text style={styles.emptyText}>No Saving suggestions</Text>
      ) : (
        <FlatList
          data={goals}
